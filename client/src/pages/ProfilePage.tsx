...
import { User, CheckCircle2, Award, BookOpen, Clock, Building, Save, Camera, Check, AlertCircle, FolderKanban } from 'lucide-react';
...
export const ProfilePage: React.FC = () => {
  ...
  const [activeSubTab, setActiveSubTab] = useState<'profile' | 'my-resources'>('profile');
      ...
      <div className="flex items-center gap-2 border-b border-purple-200 pb-3">
        <button
          ...
          className={`px-4 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-2 ${
            activeSubTab === 'profile' ? 'bg-[#6d28d9] text-white shadow-xs' : 'bg-[#f8f6ff] text-slate-700 hover:bg-purple-100'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-2 ${
            activeSubTab === 'my-resources' ? 'bg-[#6d28d9] text-white shadow-xs' : 'bg-[#f8f6ff] text-slate-700 hover:bg-purple-100'
          }`}
        >
